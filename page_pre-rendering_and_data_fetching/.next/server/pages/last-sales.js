...
async function getStaticProps() {
  const response = await fetch("https://nextjs-course-84ee0-default-rtdb.firebaseio.com/sales.json");
...
const LastSalesPage = props => {
  ...
  const {
    error
  } = swr__WEBPACK_IMPORTED_MODULE_2___default()("https://nextjs-course-84ee0-default-rtdb.firebaseio.com/sales.json", fetcher); // useEffect(() => {
  //   setIsLoading(true);
